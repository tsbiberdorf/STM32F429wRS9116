...
/*==============================================*/
/**
 * @fn         rsi_ble_set_wo_resp_notify_buf_info 
 * @brief      set the buffer configuration.
...
/*==============================================*/
/**
 * @fn         rsi_ble_indicate_confirm 
 * @brief      Indicate Confirmation to remote device.
 * @return     int32_t 
 *             0  =  success
 *             !0 = failure 
 * @section description
 * This function is used to send indicate confirmation to remote device.
 */
...
/*==============================================*/
/**
 * @fn         rsi_ble_mtu_exchange_event
 * @brief      Send MTU exchange request
 ...
 * This function is used to send att error response
 */
int32_t rsi_ble_mtu_exchange_event (uint8_t *dev_addr,
                                     uint8_t mtu_size)
{
 ...
 /*==============================================*/
 /**
 * @fn         rsi_ble_gatt_write_response 
 * @brief      send write response  to the received write request
 * @param[in]  dev_addr, remote device BD Address
 * @param[in]  type, 0 -  write response, 1- execute write response.
 * @return     int32_t 
 *             0  =  success
 *             !0 = failure 
 * @section description
 * This function is used to send the local attribute value to remote device
 */
int32_t rsi_ble_gatt_write_response(uint8_t  *dev_addr,
                                    uint8_t   type)
{
  rsi_ble_gatt_write_response_t  local_write_resp = {{0}};
#ifdef BD_ADDR_IN_ASCII
...
/*==============================================*/
/**
 * @fn         rsi_ble_gatt_prepare_write_response 
 * @brief      send prepare write response  to the received write request
 * @param[in]  dev_addr, remote device BD Address
 * @param[in]  handle, att handle
 * @param[in]  offset, att offset
 * @param[in]  data_len, lentgh of the data to be sent in response
...
int32_t rsi_ble_gatt_prepare_write_response(uint8_t  *dev_addr,
                                            ...
                                            uint8_t   *data )
{
  rsi_ble_gatt_prepare_write_response_t  local_prepare_write_resp= {{0}};
#ifdef BD_ADDR_IN_ASCII
