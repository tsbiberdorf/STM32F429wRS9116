...
#else
  memcpy (bt_req_hid_connect.dev_addr, (int8_t *)remote_dev_addr, 6);
#endif
...
#else
  memcpy (bt_req_hid_profile_data.dev_addr, (int8_t *)remote_dev_addr, 6);
#endif
...
#else
  memcpy (bt_req_hid_disconnect.dev_addr, (int8_t *)remote_dev_addr, 6);
#endif
