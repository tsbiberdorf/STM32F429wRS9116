...
int32_t rsi_zigb_send_cmd(uint8_t *cmd, rsi_pkt_t *pkt)
{
  ...
  switch(cmd[1])
    ...
    case ZIGBEENVMUPDATE:
      {
        uint16_t offset = *(uint16_t*)pkt->data;
...
#endif
/**
 * @fn          void rsi_zigb_register_callbacks 
 * @brief       This function registers the zigbee callbacks
 * @param[in]   rsi_zigb_app_scan_complete_handler_t                      zigb_app_scan_complete_handler              
 * @param[in]   rsi_zigb_app_energy_scan_result_handler_t                 zigb_app_energy_scan_result_handler
 * @param[in]   rsi_zigb_app_network_found_handler_t                      zigb_app_network_found_handler
 * @param[in]   rsi_zigb_app_stack_status_handler_t                       zigb_app_stack_status_handler
 * @param[in]   rsi_zigb_app_incoming_many_to_one_route_req_handler_t     zigb_app_incoming_many_to_one_route_req_handler 
 * @param[in]   rsi_zigb_app_handle_data_indication_t                     zigb_app_handle_data_indication
 * @param[in]   rsi_zigb_app_handle_data_confirmation_t                   zigb_app_handle_data_confirmation
 * @param[in]   rsi_zigb_app_child_join_handler_t                         zigb_app_child_join_handler
 * @param[in]   rsi_zigb_nvm_backup_handler_t                             zigb_nvm_backup_handler
 * @param[in]   rsi_zigb_zdp_app_response_handler_t                       zigb_zdp_app_response_handler
 * @param[out]
 * @return     
 *              Non zero - If fails
 *              0 - If success
...
#ifdef ZB_MAC_API
/**
 * @fn          void rsi_zigb_register_mac_callbacks 
 * @brief       This function registers the zigbee callbacks
...
int8_t rsi_zigb_cb_init(rsi_zigb_cb_t *zigb_cb)
{
  ...
  retval = rsi_semaphore_create(&zigb_cb->zigb_sem, 0);
