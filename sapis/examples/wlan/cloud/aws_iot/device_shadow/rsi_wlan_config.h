...
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP   (EXT_FEAT_384K_MODE | EXT_FEAT_RSA_KEY_WITH_4096_SUPPORT |EXT_FEAT_SSL_CERT_WITH_4096_KEY_SUPPORT)

#define RSI_EXT_TCPIP_FEATURE_BITMAP EXT_TCP_IP_FEAT_SSL_MEMORY_CLOUD  
