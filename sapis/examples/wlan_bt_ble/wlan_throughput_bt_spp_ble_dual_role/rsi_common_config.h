...
//! Applies in coex mode:
//!	To measure wlan throughput after bt/ble connection, set below macro to '1'
//! else throughput starts independent of bt/ble connections
#define	WLAN_THROUGHPUT_AFTER_BT_BLE_CONN	1
