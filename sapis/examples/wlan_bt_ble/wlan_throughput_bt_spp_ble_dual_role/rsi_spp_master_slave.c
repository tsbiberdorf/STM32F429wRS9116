...
volatile bool	bt_connected = 0;

/*=======================================================================*/
//   ! EXTERN VARIABLES
/*=======================================================================*/
extern bool	rsi_ble_running, rsi_bt_running, rsi_wlan_running;
extern rsi_semaphore_handle_t bt_inquiry_sem, ant_app_sem, bt_app_sem;
#if WLAN_SYNC_REQ
...
void rsi_bt_app_on_conn (uint16_t resp_status, rsi_bt_event_bond_t *conn_event)
{
	...
	LOG_PRINT ("on_conn: str_conn_bd_addr: %s, resp_status: 0x%x\r\n",
			rsi_6byte_dev_address_to_ascii(str_conn_bd_addr, conn_event->dev_addr), resp_status);
}
...
void rsi_bt_app_on_auth_complete (uint16_t resp_status, rsi_bt_event_auth_complete_t *auth_complete)
{
	...
	LOG_PRINT ("auth_complete: str_conn_bd_addr: %s, resp_status: 0x%x\r\n",
			rsi_6byte_dev_address_to_ascii(str_conn_bd_addr, auth_complete->dev_addr), resp_status);
}
