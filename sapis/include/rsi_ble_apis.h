 ...
 * @brief      set the locak irk of the device
 * @return     int32_t
 *             0  =  success
 *             !0 = failure
 * @section description
 * This function is used to rsi_ble_set_local_irk_value 
 * */
 ...
 * This callback has to be registered using rsi_ble_gap_register_callbacks API
 */
typedef void (*rsi_ble_on_remote_conn_params_request_t) (rsi_ble_event_remote_conn_param_req_t *rsi_ble_event_remote_conn_param, uint16_t resp_status);
