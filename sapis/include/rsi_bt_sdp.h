...
#define  BT_MEM_WR_BE_08U(addr, val)   {(*(((uint8_t     *)(addr)) + 0)) = ((uint8_t    )((((uint8_t    )(val)) &       0xFF) >> (0 * 8))); }

#define  BT_MEM_WR_BE_16U(addr, val)   {(*(((uint8_t     *)(addr)) + 0)) = ((uint8_t    )((((uint16_t    )(val)) &     0xFF00) >> (1 * 8))); \
                                        (*(((uint8_t     *)(addr)) + 1)) = ((uint8_t    )((((uint16_t    )(val)) &     0x00FF) >> (0 * 8))); }

#define  BT_MEM_WR_BE_32U(addr, val)   {(*(((uint8_t      *)(addr)) + 0)) = ((uint8_t   )((((uint32_t    )(val)) &     0xFF000000) >> (3 * 8))); \
