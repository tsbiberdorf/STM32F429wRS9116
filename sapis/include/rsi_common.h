...
#define RSI_WLAN_POOL_SIZE ((((((uint32_t)(sizeof(rsi_pkt_pool_t))) + 3) & ~3)) + ((RSI_WLAN_CMD_LEN + sizeof(void *)) * RSI_WLAN_TX_POOL_PKT_COUNT))

//! pool size of WLAN tx packets 
#define RSI_ZIGB_POOL_SIZE ((((((uint32_t)(sizeof(rsi_pkt_pool_t))) + 3) & ~3)) + ((RSI_ZIGB_CMD_LEN + sizeof(void *)) * RSI_ZIGB_TX_POOL_PKT_COUNT))
...
#define RSI_COMMON_POOL_SIZE ((((((uint32_t)(sizeof(rsi_pkt_pool_t))) + 3) & ~3)) + ((RSI_COMMON_CMD_LEN + sizeof(void *)) * RSI_COMMON_TX_POOL_PKT_COUNT))
...
#define RSI_DRIVER_RX_POOL_SIZE ((((((uint32_t)(sizeof(rsi_pkt_pool_t))) + 3) & ~3)) + ((RSI_DRIVER_RX_PKT_LEN + sizeof(void *)) * RSI_DRIVER_RX_POOL_PKT_COUNT))
...
#define RSI_SOCKET_INFO_POOL_ROM_SIZE (((((uint32_t)(sizeof(rsi_socket_info_non_rom_t))) + 3) & ~3) * RSI_NUMBER_OF_SOCKETS )
#define RSI_SOCKET_SELECT_INFO_POOL_SIZE (((((uint32_t)(sizeof(rsi_socket_select_info_t))) + 3) & ~3) * RSI_NUMBER_OF_SELECTS )
#else
...
#define RSI_ANT_CMD_LEN        300 //TODO Fix it
...
#define RSI_BT_COMMON_POOL_SIZE ((((((uint32_t)(sizeof(rsi_pkt_pool_t))) + 3) & ~3)) + ((RSI_BT_COMMON_CMD_LEN + sizeof(void *)) * RSI_BT_COMMON_TX_POOL_PKT_COUNT))


//! pool size of BT Classic tx packets 
#define RSI_BT_CLASSIC_POOL_SIZE ((((((uint32_t)(sizeof(rsi_pkt_pool_t))) + 3) & ~3)) + ((RSI_BT_CLASSIC_CMD_LEN + sizeof(void *)) * RSI_BT_CLASSIC_TX_POOL_PKT_COUNT))


//! pool size of BLE tx packets 
#define RSI_BLE_POOL_SIZE ((((((uint32_t)(sizeof(rsi_pkt_pool_t))) + 3) & ~3)) + ((RSI_BLE_CMD_LEN + sizeof(void *)) * RSI_BLE_TX_POOL_PKT_COUNT))
//! pool size of ANT tx packets 
#define RSI_ANT_POOL_SIZE ((((((uint32_t)(sizeof(rsi_pkt_pool_t))) + 3) & ~3)) + ((RSI_ANT_CMD_LEN + sizeof(void *)) * RSI_ANT_TX_POOL_PKT_COUNT))
...
#ifdef RSI_ZB_ENABLE 
#define RSI_ZB_MEMORY_POOL_SIZE ((((uint32_t)(sizeof(rsi_zigb_cb_t))) + 3) & ~3) + RSI_ZIGB_POOL_SIZE + ZB_GLOBAL_BUF_SIZE
#else
#define RSI_ZB_MEMORY_POOL_SIZE  0
#endif 

#if (defined RSI_BT_ENABLE || defined RSI_BLE_ENABLE || defined RSI_ANT_ENABLE) 
#define RSI_BT_BLE_ANT_MEMORY_POOL_SIZE  ((((uint32_t)(sizeof(rsi_bt_cb_t))) + 3) & ~3) + RSI_BT_COMMON_POOL_SIZE + ((((uint32_t)( sizeof(rsi_bt_global_cb_t))) + 3) & ~3)
#else
#define RSI_BT_BLE_ANT_MEMORY_POOL_SIZE 0
#endif 

#ifdef RSI_BT_ENABLE 
#define RSI_BT_MEMORY_POOL_SIZE  ((((uint32_t)(sizeof(rsi_bt_cb_t))) + 3) & ~3) + RSI_BT_CLASSIC_POOL_SIZE + ((((uint32_t)(sizeof(rsi_bt_classic_cb_t))) + 3) & ~3)
#else
#define RSI_BT_MEMORY_POOL_SIZE  0
#endif 

#ifdef RSI_BLE_ENABLE 
#define RSI_BLE_MEMORY_POOL_SIZE  ((((uint32_t)(sizeof(rsi_bt_cb_t))) + 3) & ~3) + RSI_BLE_POOL_SIZE + ((((uint32_t)(sizeof(rsi_ble_cb_t))) + 3) & ~3)
#else
#define RSI_BLE_MEMORY_POOL_SIZE 0
#endif

#ifdef RSI_ANT_ENABLE
#define ANT_MEMORY_SIZE  ((((uint32_t)(sizeof(rsi_bt_cb_t))) + 3) & ~3) + RSI_ANT_POOL_SIZE +  ((((uint32_t)(sizeof(rsi_ant_cb_t) )) + 3) & ~3)
#else
#define ANT_MEMORY_SIZE 0 
#endif
...
#define RSI_DRIVER_POOL_SIZE   ((((uint32_t)( sizeof(rsi_driver_cb_t))) + 3) & ~3)  + RSI_DRIVER_RX_POOL_SIZE + ((((uint32_t)( sizeof(rsi_common_cb_t))) + 3) & ~3) \
                               + ((((uint32_t)( sizeof(rsi_driver_cb_non_rom_t))) + 3) & ~3) + RSI_COMMON_POOL_SIZE + ((((uint32_t)(sizeof(rsi_wlan_cb_t))) + 3) & ~3) \
                               + RSI_WLAN_POOL_SIZE + RSI_M4_MEMORY_POOL_SIZE+ RSI_SOCKET_INFO_POOL_SIZE \
                               + RSI_SOCKET_INFO_POOL_ROM_SIZE + RSI_SOCKET_SELECT_INFO_POOL_SIZE + SCAN_RESULTS_MEMORY_POOL_SIZE + RSI_ZB_MEMORY_POOL_SIZE  \
                               + RSI_BT_BLE_ANT_MEMORY_POOL_SIZE + RSI_BT_MEMORY_POOL_SIZE + RSI_BLE_MEMORY_POOL_SIZE + ANT_MEMORY_SIZE  + BT_STACK_ON_HOST_MEMORY \
                               + RSI_EVENT_INFO_POOL_SIZE + RSI_WLAN_CB_NON_ROM_POOL_SIZE + ((((uint32_t)( sizeof(global_cb_t))) + 3) & ~3) \
                               + ((((uint32_t)( sizeof(rom_apis_t))) + 3) & ~3)
 
#define RSI_WAIT_FOREVER                               5000000
#define RSI_WAITING_FOR_OK                             5000000
#define RSI_WAIT_IN_MS                                 60000
#define RSI_CARD_READY_WAIT_TIME                       60000
#define RSI_WAIT_TIME                                  5000000
#define RSI_TIMEOUT_RESPONSE_WAIT_TIME                 60000
#define RSI_INIT_RESPONSE_WAIT_TIME                    60000
#define RSI_WLAN_CONFIG_WAIT_TIME                      60000
#define RSI_WLAN_GET_RANDOM_WAIT_TIME                  60000
#define RSI_WLAN_RSSI_RESPONSE_WAIT_TIME               60000
#define RSI_WLAN_QUERY_NETWORK_PARAMS_WAIT_TIME        60000
#define RSI_WLAN_REQ_QUERY_GO_PARAMS_WAIT_TIME         60000
#define RSI_WLAN_REQ_GET_CFG_WAIT_TIME                 60000
#define RSI_WLAN_REQ_GET_STATS_WAIT_TIME               60000
#define RSI_WLAN_CFG_SAVE_WAIT_TIME                    60000
#define	RSI_BOARD_READY_WAIT_TIME		                   60000
#define	RSI_OPERMODE_RESPONSE_WAIT_TIME		             60000  
#define	RSI_BAND_RESPONSE_WAIT_TIME		                 60000
#define	RSI_MAC_RESPONSE_WAIT_TIME		                 60000
#define	RSI_MULTICAST_FIL_RESPONSE_WAIT_TIME           60000
#define	RSI_REGION_RESPONSE_WAIT_TIME		               60000
#define	RSI_REGION_AP_RESPONSE_WAIT_TIME		           60000
#define	RSI_REJOIN_RESPONSE_WAIT_TIME		               200000
#define	RSI_AUTO_JOIN_RESPONSE_WAIT_TIME		           200000
#define	RSI_EAP_RESPONSE_WAIT_TIME		                 60000 
#define	RSI_SCAN_RESPONSE_WAIT_TIME		                 60000
#define	RSI_SCAN_WITH_BITMAP_RESPONSE_WAIT_TIME        60000
#define	RSI_DRIVER_SEND_DATA_RESPONSE_WAIT_TIME        60000
#define	RSI_SLEEP_TIMER_RESPONSE_WAIT_TIME             60000
#define	RSI_SET_SLEEP_TIMER_RESPONSE_WAIT_TIME         60000
#define	RSI_WAC_MFI_RESPONSE_WAIT_TIME                 60000
#define	RSI_COMMON_SEND_CMD_RESPONSE_WAIT_TIME         60000
#define	RSI_WLAN_SEND_CMD_RESPONSE_WAIT_TIME           60000 
#define	RSI_NWK_SEND_CMD_RESPONSE_WAIT_TIME            600000
#define	RSI_COMMON_DEV_CONFIG_WAIT_TIME                60000
#define	RSI_JOIN_RESPONSE_WAIT_TIME		                 200000
#define	RSI_P2P_RESPONSE_WAIT_TIME		                 60000
#define	RSI_PSK_RESPONSE_WAIT_TIME		                 60000
#define	RSI_BGSCAN_RESPONSE_WAIT_TIME		               60000
#define	RSI_ROAMING_RESPONSE_WAIT_TIME		             60000
#define	RSI_DISCONNECT_RESPONSE_WAIT_TIME		           60000 
#define	RSI_TRANSMIT_RESPONSE_WAIT_TIME		             60000 
#define	RSI_RX_STATS_RESPONSE_WAIT_TIME		             60000 
#define	RSI_DYNAMIC_RESPONSE_WAIT_TIME		             60000 
#define	RSI_PING_RESPONSE_WAIT_TIME		                 200000
#define	RSI_SOCKET_CREATE_RESPONSE_WAIT_TIME           200000
#define	RSI_SOCKET_CLOSE_RESPONSE_WAIT_TIME            200000
#define	RSI_CERTIFICATE_RESPONSE_WAIT_TIME	           60000
#define	RSI_WEP_RESPONSE_WAIT_TIME		                 60000
#define	RSI_IPCONFV4_RESPONSE_WAIT_TIME		             60000
#define	RSI_IPCONFV6_RESPONSE_WAIT_TIME		             100000
#define	RSI_MDNSD_RESPONSE_WAIT_TIME		               200000
#define	RSI_SMTP_RESPONSE_WAIT_TIME		                 200000
#define	RSI_ACCEPT_RESPONSE_WAIT_TIME		               6000000
#define RSI_CERT_RESPONSE_WAIT_TIME                    60000 
#define RSI_DNS_QUERY_RESPONSE_WAIT_TIME               200000 
#define RSI_DNS_UPDATE_RESPONSE_WAIT_TIME              200000 
#define RSI_DNS_SERVER_ADD_RESPONSE_WAIT_TIME          200000 
#define RSI_DHCP_UC_RESPONSE_WAIT_TIME                 200000 
#define RSI_AP_CONFIG_RESPONSE_WAIT_TIME               60000 
#define RSI_HT_CAPS_RESPONSE_WAIT_TIME                 60000 
#define RSI_FTP_RESPONSE_WAIT_TIME                     200000 
#define RSI_WMM_RESPONSE_WAIT_TIME                     60000 
#define RSI_MULTICAST_RESPONSE_WAIT_TIME               60000 
#define RSI_FWUP_RESPONSE_WAIT_TIME                    500000 
#define RSI_WP_LOAD_RESPONSE_WAIT_TIME                 200000 
#define RSI_JSON_LOAD_RESPONSE_WAIT_TIME               200000 
#define RSI_WP_ERASE_RESPONSE_WAIT_TIME                200000 
#define RSI_JSON_ERASE_RESPONSE_WAIT_TIME              200000 
#define RSI_WP_CLEAR_ALL_RESPONSE_WAIT_TIME            200000 
#define RSI_HOST_WP_SEND_RESPONSE_WAIT_TIME            200000 
#define RSI_POP3_RESPONSE_WAIT_TIME                    60000 
#define RSI_HTTP_RESPONSE_WAIT_TIME                    60000 
#define	RSI_HTTP_CLIENT_POST_RESPONSE_WAIT_TIME		     200000 
#define	RSI_HTTP_CLIENT_GET_RESPONSE_WAIT_TIME		     200000
#define	RSI_HTTP_ABORT_RESPONSE_WAIT_TIME		           200000
#define	RSI_HTTP_CLIENT_PUT_RESPONSE_WAIT_TIME		     200000
#define RSI_OTA_FWUP_RESPONSE_WAIT_TIME                100000 
#define RSI_SET_PROFILE_RESPONSE_WAIT_TIME             60000
#define RSI_GET_PROFILE_RESPONSE_WAIT_TIME             60000 
#define RSI_DELETE_PROFILE_RESPONSE_WAIT_TIME          60000 
#define RSI_AUTO_CONFIG_RESPONSE_WAIT_TIME             60000 
#define RSI_SOCK_CONFIG_RESPONSE_WAIT_TIME             60000 
#define RSI_BCAST_RESPONSE_WAIT_TIME                   60000 
#define RSI_SNTP_RESPONSE_WAIT_TIME                    200000  
#define RSI_USER_SC_RESPONSE_WAIT_TIME                 60000 
#define RSI_ANTENNA_SEL_RESPONSE_WAIT_TIME             60000
#define RSI_DEBUG_LOG_RESPONSE_WAIT_TIME               60000
#define RSI_SWITCH_PROTO_RESPONSE_WAIT_TIME            60000
#define RSI_GET_RAM_DUMP_RESPONSE_WAIT_TIME            600000
#define RSI_FEATURE_FRAME_RESPONSE_WAIT_TIME           60000 
#define RSI_SOFT_RESET_RESPONSE_WAIT_TIME              600000 
#define RSI_UART_FLOW_CTRL_RESPONSE_WAIT_TIME          600000 
#define RSI_PWRMODE_RESPONSE_WAIT_TIME                 600000 
#define RSI_IAP_RESPONSE_WAIT_TIME                     600000 
#define RSI_IAP_GET_CERT_RESPONSE_WAIT_TIME            600000 
#define RSI_IAP_GEN_SIG_RESPONSE_WAIT_TIME             600000 
#define RSI_PUF_ENROLL_RESPONSE_WAIT_TIME              600000 
#define RSI_PUF_DIS_ENROLL_RESPONSE_WAIT_TIME          600000 
#define RSI_PUF_START_RESPONSE_WAIT_TIME               600000 
#define RSI_PUF_SET_RESPONSE_WAIT_TIME                 600000 
#define RSI_PUF_DIS_SET_RESPONSE_WAIT_TIME             600000 
#define RSI_PUF_GET_RESPONSE_WAIT_TIME                 600000 
#define RSI_PUF_DIS_GET_RESPONSE_WAIT_TIME             600000 
#define RSI_PUF_LOAD_RESPONSE_WAIT_TIME                600000 
#define RSI_AES_ENCRYPT_RESPONSE_WAIT_TIME             600000 
#define RSI_AES_DECRYPT_RESPONSE_WAIT_TIME             600000 
#define RSI_AES_MAC_RESPONSE_WAIT_TIME                 600000 
#define RSI_PUF_INTR_RESPONSE_WAIT_TIME                600000 
#define RSI_CRYPTO_RESPONSE_WAIT_TIME                  600000 
#define RSI_TA_M4_COMMAND_RESPONSE_WAIT_TIME           600000 
#define RSI_CONNECT_RESPONSE_WAIT_TIME                 600000  
#define RSI_SEND_DATA_RESPONSE_WAIT_TIME               600000 
#define RSI_RAW_DATA_RESPONSE_WAIT_TIME                600000 
#define RSI_WPS_RESPONSE_WAIT_TIME                     180000 
#define RSI_GAIN_TABLE_RESPONSE_WAIT_TIME              600000 
#define RSI_DEINIT_RESPONSE_WAIT_TIME                  600000 
#define RSI_ZIGB_RESPONSE_WAIT_TIME                    600000 
#define RSI_ADD_MFI_IE_RESPONSE_WAIT_TIME              600000 
#define RSI_AP_START_RESPONSE_WAIT_TIME                600000 
...
#endif
#define RSI_DRIVER_WLAN_SEND_CMD_RESPONSE_WAIT_TIME    600000 
#define RSI_FILTER_BROADCAST_RESPONSE_WAIT_TIME        600000 
#define RSI_ROM_WL_DRIVER_SEND_DATA_RESPONSE_WAIT_TIME 600000 
#define RSI_SELECT_RESPONSE_WAIT_TIME                  6000000 
#define RSI_SOCKET_RECVFROM_RESPONSE_WAIT_TIME         600000
#define RSI_SET_RTC_TIMER_RESPONSE_WAIT_TIME           600000 
#define RSI_WLAN_RADIO_RESPONSE_WAIT_TIME              600000 
#define RSI_GET_RTC_TIMER_RESPONSE_WAIT_TIME           600000 
#define RSI_EMB_MQTT_RESPONSE_WAIT_TIME                600000 


//BT/BLE command timeouts in ms
#define SCALE_FACTOR                           300000
#define RSI_BT_COMMON_CMD_RESP_WAIT_TIME       SCALE_FACTOR + 5000
#define RSI_BT_A2DP_CMD_RESP_WAIT_TIME         SCALE_FACTOR + 5000
#define RSI_BT_A2DP_DATA_CMD_RESP_WAIT_TIME    SCALE_FACTOR + 20000
#define RSI_BT_AVRCP_CMD_RESP_WAIT_TIME        SCALE_FACTOR + 2000
#define RSI_BT_HFP_CMD_RESP_WAIT_TIME          SCALE_FACTOR + 5000
#define RSI_BT_PBAP_CMD_RESP_WAIT_TIME         SCALE_FACTOR + 5000
#define RSI_BT_HID_CMD_RESP_WAIT_TIME          SCALE_FACTOR + 5000
#define RSI_BT_SPP_CMD_RESP_WAIT_TIME          SCALE_FACTOR + 5000

#define RSI_BLE_GAP_CMD_RESP_WAIT_TIME         SCALE_FACTOR + 5000
#define RSI_BLE_GATT_CMD_RESP_WAIT_TIME        SCALE_FACTOR + 2000

#define RSI_BT_BLE_CMD_MAX_RESP_WAIT_TIME      SCALE_FACTOR +20000

#define RSI_ANT_CMD_TX_PKT_SEND_WAIT_TIME      SCALE_FACTOR +20000
...
#endif
  volatile uint8_t pwr_save_exp_resp;
