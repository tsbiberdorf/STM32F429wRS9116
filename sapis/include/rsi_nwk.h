...
int32_t rsi_http_client_async(uint8_t type, uint8_t flags, uint8_t *ip_address, uint16_t port, 
                            ...
                            void(*callback)(uint16_t status, const uint8_t *buffer, const uint16_t length, uint32_t moredata, uint16_t status_code));
#else 
int32_t rsi_http_client_async(uint8_t type, uint8_t flags, uint8_t *ip_address, uint16_t port, 
                            uint8_t *resource, uint8_t *host_name, uint8_t *extended_header, 
                            uint8_t *user_name, uint8_t *password, uint8_t *post_data, uint32_t post_data_length,
...
int32_t rsi_dns_update(uint8_t ip_version, uint8_t *zone_name, uint8_t *host_name, uint8_t *server_address,
                                      uint16_t ttl, void(*dns_update_rsp_handler)(uint16_t status));
