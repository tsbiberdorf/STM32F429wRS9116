...
typedef struct rsi_fd_set_s                /* The select socket array manager.                                                             */
{ 
...
int32_t  rsi_socket_async(int32_t protocolFamily, int32_t type, int32_t protocol, void (*)(uint32_t sock_no, uint8_t *buffer, uint32_t length));
