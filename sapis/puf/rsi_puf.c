...
int32_t  rsi_puf_enroll_req(void)
{
	...
	if((wlan_cb->state < RSI_WLAN_STATE_OPERMODE_DONE) || (rsi_common_cb->puf_state > RSI_PUF_STATE_NONE))
	{
	...
	if(pkt == NULL)
  {
	...
	status = rsi_driver_common_send_cmd(RSI_COMMON_REQ_PUF_ENROLL, pkt);

  //! wait on common semaphore
  rsi_wait_on_common_semaphore(&rsi_driver_cb_non_rom->common_cmd_sem, RSI_PUF_ENROLL_RESPONSE_WAIT_TIME);
...
int32_t  rsi_puf_enroll_disable_req(void)
{
  ...
  if(rsi_check_and_update_cmd_state(COMMON_CMD,IN_USE) == RSI_SUCCESS)
  {
	...
	//! send webpage erase request command
	status = rsi_driver_common_send_cmd(RSI_COMMON_REQ_PUF_DIS_ENROLL, pkt);

  //! wait on common semaphore
  rsi_wait_on_common_semaphore(&rsi_driver_cb_non_rom->common_cmd_sem, RSI_PUF_DIS_ENROLL_RESPONSE_WAIT_TIME);
...
int32_t  rsi_puf_start_req(void)
{
  ...
  //! wait on common semaphore
  rsi_wait_on_common_semaphore(&rsi_driver_cb_non_rom->common_cmd_sem, RSI_PUF_START_RESPONSE_WAIT_TIME);
...
int32_t  rsi_puf_set_key_req(uint8_t key_index, uint8_t key_size, uint8_t *key_ptr, uint8_t *set_key_resp, uint16_t length)
{
  ...
  //! wait on common semaphore
  rsi_wait_on_common_semaphore(&rsi_driver_cb_non_rom->common_cmd_sem, RSI_PUF_SET_RESPONSE_WAIT_TIME);
...
int32_t  rsi_puf_set_key_disable_req(void)
{
  ...
  //! wait on common semaphore
  rsi_wait_on_common_semaphore(&rsi_driver_cb_non_rom->common_cmd_sem, RSI_PUF_DIS_SET_RESPONSE_WAIT_TIME);
...
int32_t  rsi_puf_get_key_req(uint8_t *keycode_ptr, uint8_t *get_key_resp, uint16_t length)
{
  ...
  //! wait on common semaphore
  rsi_wait_on_common_semaphore(&rsi_driver_cb_non_rom->common_cmd_sem, RSI_PUF_GET_RESPONSE_WAIT_TIME);
...
int32_t  rsi_puf_get_key_disable_req(void)
{
  ...
  //! wait on common semaphore
  rsi_wait_on_common_semaphore(&rsi_driver_cb_non_rom->common_cmd_sem, RSI_PUF_DIS_GET_RESPONSE_WAIT_TIME);
...
int32_t  rsi_puf_load_key_req(uint8_t *keycode_ptr)
{
  ...
  if(rsi_check_and_update_cmd_state(COMMON_CMD,IN_USE) == RSI_SUCCESS)
  {
   ...
   //! wait on common semaphore
  rsi_wait_on_common_semaphore(&rsi_driver_cb_non_rom->common_cmd_sem, RSI_PUF_LOAD_RESPONSE_WAIT_TIME);
...
int32_t  rsi_puf_aes_encrypt_req(uint8_t mode, uint8_t key_source, uint16_t key_size, uint8_t *key_ptr, uint16_t data_size, uint8_t *data_ptr, uint16_t iv_size, uint8_t *iv_ptr,uint8_t *aes_encry_resp, uint16_t length)
{
  ...
  //! wait on common semaphore
  rsi_wait_on_common_semaphore(&rsi_driver_cb_non_rom->common_cmd_sem, RSI_AES_ENCRYPT_RESPONSE_WAIT_TIME);
...
int32_t  rsi_puf_aes_decrypt_req(uint8_t mode, uint8_t key_source, uint16_t key_size, uint8_t *key_ptr, uint16_t data_size, uint8_t *data_ptr, uint16_t iv_size, uint8_t *iv_ptr,uint8_t *aes_decry_resp, uint16_t length)
{
  ...
  //! wait on common semaphore
  rsi_wait_on_common_semaphore(&rsi_driver_cb_non_rom->common_cmd_sem, RSI_AES_DECRYPT_RESPONSE_WAIT_TIME);
...
int32_t  rsi_puf_aes_mac_req(uint8_t key_source, uint16_t key_size, uint8_t *key_ptr, uint16_t data_size, uint8_t *data_ptr, uint16_t iv_size, uint8_t *iv_ptr,uint8_t *aes_mac_resp, uint16_t length)
{
  ...
  //! wait on common semaphore
  rsi_wait_on_common_semaphore(&rsi_driver_cb_non_rom->common_cmd_sem, RSI_AES_MAC_RESPONSE_WAIT_TIME);
...
int32_t  rsi_puf_intr_key_req(uint8_t key_index, uint8_t key_size, uint8_t *intr_key_resp, uint16_t length)
{
  ...
  //! wait on common semaphore
  rsi_wait_on_common_semaphore(&rsi_driver_cb_non_rom->common_cmd_sem, RSI_PUF_INTR_RESPONSE_WAIT_TIME);
